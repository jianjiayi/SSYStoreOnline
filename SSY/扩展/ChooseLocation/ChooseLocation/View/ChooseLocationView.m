...
//    separateLine.top = topView.height - separateLine.height;
    ...
    underLine.layer.cornerRadius = 1.5f;
    UIButton * btn = self.topTabbarItems.lastObject;
    [self changeUnderLineFrame:btn];
    underLine.top = separateLine1.top - underLine.height;
    
    _underLine.backgroundColor = [UIColor colorWithRed:72/255.0 green:188/255.0 blue:119/255.0 alpha:1/1.0];
...
- (void)addTopBarItem{
    ...
    [topBarItem setTitleColor: [UIColor colorWithRed:16/255.0 green:0/255.0 blue:0/255.0 alpha:1/1.0] forState:UIControlStateNormal];
    topBarItem.titleLabel.font = PFR16Font;
    [topBarItem setTitleColor: [UIColor colorWithRed:16/255.0 green:0/255.0 blue:0/255.0 alpha:1/1.0] forState:UIControlStateSelected];
